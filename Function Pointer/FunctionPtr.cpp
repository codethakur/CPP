...
int main()
{
	...
	bool (*ascendFuncPtr)(int, int) = ascendingCompare;
	bool (*descendFuncPtr)(int, int) = descendingCompare;


	customSort(numbersVector, ascendFuncPtr);
	// or
	// customSort(numbersVector, descendFuncPtr);
